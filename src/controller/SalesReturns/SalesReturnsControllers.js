...
//External Lib Import
const ParentModel = require("../../model/SalesReturn/SalesReturnsSummaryModel");
const ChildModel = require("../../model/SalesReturn/SalesReturnsModel");
...
/**
 * @desc Sales Returns Create
 * @access private
 * @route /api/v1/SalesReturns/SalesReturnsCreate
 * @methud POST
 */

const SalesReturnsCreate = async (req, res, next) => {
...
/**
 * @desc Sales Returns List
 * @access private
 * @route /api/v1/SalesReturns/SalesReturnsList/:pageNumber/:perPage/:searchKeyword
 * @methud GET
 */

const SalesReturnsList = async (req, res, next) => {
...
/**
 * @desc SalesReturns Delete
 * @access private
 * @route /api/v1/SalesReturns/SalesReturnsDelete/:pageNumber/:perPage/:searchKeyword
 * @methud DETELE
 */

const SalesReturnsDelete = async (req, res, next) => {
  const session = await mongoose.startSession();
