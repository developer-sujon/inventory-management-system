                ...
                <Col sm={7}>
                  <div className="text-sm-end">
                    ...
                    <Button
                      variant="light"
                      className="mb-2 me-1"
                      onClick={() => ExportDataJSON(UnitLists, "Unit", "xls")}
                    >
                    ...
                    <Button
                      variant="light"
                      className="mb-2"
                      onClick={() => ExportDataJSON(UnitLists, "Unit", "csv")}
                    >
                            ...
                            <td>
                              <span
                                className={classNames("badge", {
                                  "bg-success": record?.UnitStatus,
                                  "bg-danger": !record?.UnitStatus,
                                })}
                              >
                ...
                <Col>
                  <div className="d-lg-flex align-items-center text-center pb-1">
                    ...
                    <span className="me-3">
                      Page
                      <strong>
                        {pageNumber} of {Math.ceil(TotalUnit / perPage)}
                      </strong>
                    </span>
